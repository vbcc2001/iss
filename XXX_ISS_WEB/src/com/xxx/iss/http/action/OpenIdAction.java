 ...
 * @since
 */
public class OpenIdAction extends BaseAction {
	...
	public ActionResult doDefault() {
		...
		String result = this.sendPost(url, "secret="+secret+"&appid="+appid+"&code="+code);
		logger.info(result);
		...
		return new ActionResult("/iss/iss.html?openid="+openid,false);
	}
	/**
     * 向指定 URL 发送POST方法的请求
     * 
